        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <Card className="shadow-xl border-0 overflow-hidden">
            <CardContent className="p-0">
                ...
                <div className="flex items-start justify-between">
                  <div className="flex items-center space-x-3 flex-1">
                    <Link to={`/profile/${post.author_username}`}>
                      <Avatar className="w-14 h-14 ring-2 ring-white shadow-lg hover:ring-rose-200 transition-all">
                        {post.author_avatar ? (
                          <img 
              ...
              {/* Stats Bar */}
              <div className="px-6 py-2 bg-gray-50 flex items-center justify-between text-sm text-gray-600">
              ...
              {/* Action Buttons */}
              <div className="px-6 py-2 flex items-center justify-around bg-white">
                <div className="relative">
                  <Button
                    ...
                    className={`flex-1 ${post.liked_by_user ? 'text-rose-600 hover:bg-rose-50' : 'text-gray-600 hover:bg-gray-50'}`}
                  >
                    <Heart className={`w-5 h-5 mr-2 ${post.liked_by_user ? 'fill-current' : ''}`} />
                ...
                <Button variant="ghost" onClick={handleShare} className="flex-1 text-gray-600 hover:bg-gray-50">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <div className="flex-1 flex gap-2">
                        <Input
                          ...
                          className="flex-1 bg-gray-100 border-0 focus:ring-1 focus:ring-rose-200 rounded-full px-4 h-9 text-sm"
                        />
                        <Button 
                          onClick={handleComment}
                          disabled={!commentContent.trim()}
                          size="sm"
                          className="bg-gradient-to-r from-rose-600 to-pink-600 hover:from-rose-700 hover:to-pink-700 rounded-full px-4 h-9"
                        >
                      ...
                      {comments.map((comment) => (
                        <div key={comment.id} className="flex items-start space-x-2">
                          <Link to={`/profile/${comment.username}`}>
                            <Avatar className="w-8 h-8 flex-shrink-0 hover:ring-2 hover:ring-rose-200 transition-all">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex items-center space-x-3 mt-1 px-2">
                              <button className="text-xs text-gray-500 hover:text-rose-600 font-semibold">
                                Like
                              </button>
                              ...
                              {user && user.id === comment.user_id && (
                                <button 
                                  ...
                                  className="text-xs text-red-500 hover:text-red-700 font-semibold ml-auto flex items-center gap-1"
                                >

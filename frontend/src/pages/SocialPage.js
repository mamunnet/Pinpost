            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-xl sm:rounded-2xl shadow-lg border border-slate-200/50 p-3 sm:p-6 sticky top-20 sm:top-24 z-10">
              ...
              <div className="grid grid-cols-3 gap-1 sm:gap-2 p-0.5 sm:p-1 bg-slate-100 rounded-lg sm:rounded-xl">
                <button
                  ...
                  className={`flex items-center justify-center py-2 sm:py-3 px-2 sm:px-4 rounded-md sm:rounded-lg text-xs sm:text-sm font-semibold transition-all duration-300 ${filter === 'all'
                ...
                <button
                  ...
                  className={`flex items-center justify-center py-2 sm:py-3 px-2 sm:px-4 rounded-md sm:rounded-lg text-xs sm:text-sm font-semibold transition-all duration-300 ${filter === 'following'
                    ? 'bg-white shadow-md text-slate-700 transform scale-105'
                    : 'text-slate-600 hover:text-slate-800'
                    }`}
                >
                ...
                <button
                  ...
                  className={`flex items-center justify-center py-2 sm:py-3 px-2 sm:px-4 rounded-md sm:rounded-lg text-xs sm:text-sm font-semibold transition-all duration-300 ${filter === 'trending'
                    ? 'bg-white shadow-md text-slate-700 transform scale-105'
                    : 'text-slate-600 hover:text-slate-800'
                    }`}
                >
                  ...
                  {filteredPosts.map((post, index) => (
                    <div key={post.id} className="group">
                      ...
                      <div className="bg-white/80 backdrop-blur-sm rounded-xl sm:rounded-2xl border border-slate-200/50 hover:border-slate-300/50 transition-all duration-300 hover:shadow-lg hover:shadow-slate-200/50 overflow-hidden">
                        <PostCard post={post} user={user} onLike={() => handleLike(post)} onComment={() => fetchPosts(true)} compact={isMobile} />
                      </div>
